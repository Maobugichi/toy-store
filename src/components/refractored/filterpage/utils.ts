...
import type { ExpandedSections } from "@/features/products/types/filter.types";
...
const updateTempFilter = <K extends keyof FilterState>(
  ...
  export const toggleSection = (section: keyof ExpandedSections, setExpandedSections:React.Dispatch<React.SetStateAction<ExpandedSections>>): void => {
