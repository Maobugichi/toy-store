...
const Category:React.FC<CategoryProps> = ({gender,src,essential,essential2}) => {
    ...
    return(
        <motion.div 
         className="group text-white h-[90%] lg:w-1/2  grid place-items-center rounded-md w-[90%] mx-auto lg:mx-0"
         initial={{ backgroundSize: '100% 100%' }}
         whileHover={{ backgroundSize: '110% 110%' }}
         transition={{ duration: 1, ease: 'easeInOut',type:"tween" }}
         style={{backgroundImage:`url(${src})`,backgroundRepeat:"no-repeat", backgroundPosition:"center", backgroundSize: "cover"}}>
