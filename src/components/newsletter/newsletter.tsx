    ...
    <section className="font-family-sans py-10 border">
      <div className="flex flex-col md:flex-row md:h-[40vh] md:w-[98%] w-[90%] mx-auto items-center justify-center gap-5">
        ...
        <div className="h-[50%] flex flex-col space-y-4 md:w-1/2">
          <h2 className="font-family-heading font-semibold text-3xl md:text-4xl">
            Come Ride with Us
          </h2>
        ...
        >
          ...
          <button
            type="submit"
            disabled={isPending}
            className="bg-black w-full md:w-32 hover:bg-white hover:text-black transition-colors duration-300 hover:border-2 hover:border-black hover:shadow text-white py-2 md:py-4 px-7 text-lg rounded-md flex items-center justify-center gap-2"
          >
            {isPending ? (
              <>
                <ClipLoader/>
