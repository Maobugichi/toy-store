...
const FeatureCard = ({ icon: Icon, title, description }:any) => (
  <div className="group relative bg-white/5 backdrop-blur-md rounded-4xl p-6 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-300">
